...
lerobot-record \
    ...
    --teleop.port=/dev/so101_leader_R \
    --teleop.id=leader_R \
    --robot.type=so101_follower \
    --robot.port=/dev/so101_follower_R \
    --robot.id=follower_R \
...
lerobot-record \
    ...
    --robot.cameras='{ 
        ...
        belly: {type: opencv, index_or_path: 6, width: 640, height: 480, fps: 30}
    }' \
    --dataset.repo_id=${HF_USER}/so101_pick_place_vis \
